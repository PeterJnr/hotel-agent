export const roomPresentation = {
  STANDARD: {
    ...
    amenities: ["King bed", "Rain shower", "City outlook", "High-speed Wi-Fi", "Breakfast available", "AI concierge"],
  },
  EXECUTIVE: {
    ...
    amenities: ["King bed", "Dedicated workspace", "Lounge seating", "Premium minibar", "High-speed Wi-Fi", "AI concierge"],
  },
  SUITE: {
    label: "The Aurelia Suite", eyebrow: "Our signature stay",
    ...
    amenities: ["Separate living room", "Super king bed", "Soaking bath", "Personal bar", "Priority service", "AI concierge"],
  },
};
