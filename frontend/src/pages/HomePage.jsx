...
export function HomePage() {
  const { user } = useAuth();
  const conciergeUrl = user ? "/portal/concierge" : "/register";
  ...
  return (
    <>
      ...
      <section className="intro section" id="story"><span className="eyebrow">A different pace</span><div><h2>Where considered design meets genuine warmth.</h2><p>Apex Solacii is a quiet counterpoint to the energy of Lagos. Every detail has been chosen to make your stay feel effortless—from the first welcome to your final morning.</p></div></section>
      ...
      <section className="experience section" id="experience"><div className="experience-image"><Link className="ai-note" to={conciergeUrl} aria-label="Meet Solacii AI"><Bot /><div><strong>Meet Solacii AI</strong><span>Your personal concierge, available anytime.</span></div><ArrowRight className="ai-note-arrow" /></Link></div><div className="experience-copy"><span className="eyebrow">Thoughtfully intelligent</span><h2>Hospitality that already knows what you need.</h2><p>Ask for a room, arrange your stay, request fresh towels, or check a payment—all through one calm conversation.</p><div className="service-list"><span><ConciergeBell />24-hour personal assistance</span><span><Coffee />Requests handled in moments</span><span><Bot />Secure, confirmation-first actions</span></div></div></section>
